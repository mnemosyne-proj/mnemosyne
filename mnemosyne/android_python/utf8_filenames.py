...
# Python 3.5 in Crystax seems to set sys.setdefaultencoding() to "ascii",
# although the Android filesystem supports UTF-8. Therefore, we wrap all
# builtin functions to encode the filenames.
