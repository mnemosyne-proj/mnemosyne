...
ifndef CRYSTAX_NDK
$(error Variable CRYSTAX_NDK unset)
endif
...
LOCAL_SRC_FILES := $(CRYSTAX_NDK)/sources/python/3.5/libs/$(TARGET_ARCH_ABI)/libpython3.5m.so
LOCAL_EXPORT_CFLAGS := -I $(CRYSTAX_NDK)/sources/python/3.5/include/python/
